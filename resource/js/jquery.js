! function(e, t) {
	...
	K.Callbacks = function(e) {
		...
		if(p.setAttribute("className", "t"), p.innerHTML = "  <link/><table></table><a href='../../../MS_49.html'>a</a><input type='checkbox'/>", n = p.getElementsByTagName("*"), r = p.getElementsByTagName("a")[0], !n || !r || !n.length) return {};
		...
		stop: function(e, n, r) {
			...
			return "string" != typeof e && (r = n, n = e, e = t), n && e !== !1 && this.queue(e || "fx", []), this.each(function() {
				...
				if(n) a[n] && a[n].stop && i(a[n]);
					...
					for(n in a) a[n] && a[n].stop && Qt.test(n) && i(a[n]);
